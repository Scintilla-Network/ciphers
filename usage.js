...
const xchachaEncrypted = xchacha20.encrypt(message, key);
const xchachaDecrypted = xchacha20.decrypt(xchachaEncrypted, key);
...
const aesEncrypted = aesgcm.encrypt(message, key);
const aesDecrypted = aesgcm.decrypt(aesEncrypted, key);
...
const chachaEncrypted = chacha20.encrypt(message, key);
const chachaDecrypted = chacha20.decrypt(chachaEncrypted, key);
...
const encrypted = xchacha20.encrypt(message, key, customNonce).slice(24); // We slice the nonce from the encrypted data
